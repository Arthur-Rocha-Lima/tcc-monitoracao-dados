...
//
// O serviço MetricService.
type MetricServiceClient interface {
	// A rpc "GetMetrics" é do tipo Unary.
	// Ela será o único "endpoint" para buscar todas as métricas.
...
func (c *metricServiceClient) GetMetrics(ctx context.Context, in *MetricsRequest, opts ...grpc.CallOption) (*MetricsResponse, error) {
...
func (UnimplementedMetricServiceServer) GetMetrics(context.Context, *MetricsRequest) (*MetricsResponse, error) {
